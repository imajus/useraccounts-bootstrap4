Package.describe({
  name: 'imajus:useraccounts-bootstrap4',
  summary: 'Accounts Templates styled for Twitter Bootstrap 4',
  version: '0.2.0',
  git: 'https://github.com/imajus/useraccounts-bootstrap4.git',
...
Package.onUse(function (api) {
  ...
  api.use(['useraccounts:core@1.17.1']);
  // Requires all routing packages loads before this asking for weak dependencies.
  api.use('useraccounts:flow-routing-extra@1.0.0', { weak: true });
  api.addFiles(
    [
      'lib/at_error.html',
      'lib/at_error.js',
